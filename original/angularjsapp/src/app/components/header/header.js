...
.controller('HeaderCtrl', ["$location", "$scope", "$state", "$location", "$timeout", "config", "session", "swf", "broadcasterService", "Api", "$translate", "$modal", "$rootScope", "eventbus", "trackingPixel", "guestService", "selfies", function HomeController($location, $scope, $state, $location, $timeout, config, session, swf, broadcasterService, Api, $translate, $modal, $rootScope, eventbus, trackingPixel, guestService, selfies) {
